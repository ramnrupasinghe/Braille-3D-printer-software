<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SquareWebForm.aspx.cs" Inherits="calculator.SquareWebForm" %>
...
<body>
    ...
    <form id="form1" runat="server">
         ...
         <br />
            <br />
          <center><asp:Label ID="Label1" runat="server" Text="Get The Perimeter Of The Square" Font-Bold="True" Font-Size="Larger" ForeColor="White" style="font-size: 40px;" ></asp:Label></center> 
          <br />
            <br />
         <br />
            <br />
         <br />
            <br />
          <center><asp:Label ID="Label2" runat="server" Text="Parameters Of The Square" Font-Bold="True" Font-Size="Larger" ForeColor="White" style="font-size: 20px;" ></asp:Label></center> 
         <br />
            <br />
         <br />
            <br />
    ...
    <center>
        <table style="font-family:Arial">
            <tr>
                <td>
                    <b style="color: #FFFFFF">Side One :</b>                           <br />
            <br />  <br />
         <br />
            <br />  <br />
         <br />
        ...
        <tr>
                <td>
                    <b style="color: #FFFFFF">Perimeter Result :</b>                           <br />
            <br />  <br />
         <br />
            <br />  <br />
         <br />
